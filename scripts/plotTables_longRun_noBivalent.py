...
# output_file = "../../analysis/{}/{}_runHistoryPlot_wSum.pdf".format(
...
# axs00.ticklabel_format(useOffset=False, style='plain')
...
# axs02.ticklabel_format(useOffset=False, style='plain')
...
# ax13.plot(steps, activated+silenced, color='#165AFF', linewidth=0.3)
