...
for x in next(os.walk(path))[1]:
    ...
    # save figure
    plt.savefig('./analysis/{}/{}_bindingNumbers_numberAnnot.pdf'.format(x,
                                                                         x), dpi=200, bbox_inches='tight')
    # plt.show()
...
plt.savefig('./analysis/bindingNumbers_{}runs_numberAnnot.pdf'.format(n_runs),
