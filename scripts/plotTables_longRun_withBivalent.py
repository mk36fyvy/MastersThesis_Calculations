...
activated_gs = gridspec.GridSpecFromSubplotSpec(
    1, 2, subplot_spec=outer_gs[0, 0], width_ratios=[3, 1], wspace=0.02)
silenced_gs = gridspec.GridSpecFromSubplotSpec(
    1, 2, subplot_spec=outer_gs[0, 1], width_ratios=[3, 1], wspace=0.02)
bivalent_gs = gridspec.GridSpecFromSubplotSpec(
    1, 2, subplot_spec=outer_gs[0, 2], width_ratios=[3, 1], wspace=0.02)
